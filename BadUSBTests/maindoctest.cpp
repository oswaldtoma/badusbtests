...
TEST_CASE("TestWordWithQuotationMarks")
{
	char buffer[20] = { '\0' };
...
TEST_CASE("TestWordWithQuotationMarksAndSomethingAfter")
{
	char buffer[20] = { '\0' };
...
TEST_CASE("TestWordWithQuotationMarksAndSpaces")
{
	char buffer[30] = { '\0' };
...
TEST_CASE("TestWordWithSpecialKeyPhraseInside")
{
	char buffer[30] = { '\0' };
...
//SCRIPT MANAGER
TEST_CASE("ScriptManagerRowCounter")
{
...
TEST_CASE("ScriptManagerWithKeyboard")
{
...
TEST_CASE("ScriptManagerTest4LongText")
{
	KeyboardFake keyboard;
	ScriptManager::init(&keyboard);
...
TEST_CASE("ScriptManagerKeysOneAfterAnother")
{
	KeyboardFake keyboard;
	ScriptManager::init(&keyboard);
